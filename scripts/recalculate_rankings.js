...
async function run() {
  ...
  try {
    ...
    console.log('📊 Analizando historia de ventas (90 días)...');
    ...
    salesRows.forEach(r => {
      salesMap.set(String(r.barcode), {
        m1: parseInt(r.m1_qty || 0),
        m2: parseInt(r.m2_qty || 0),
        m3: parseInt(r.m3_qty || 0)
      });
    });
    ...
    for (const p of products) {
      ...
      // Solo actualizar si el ranking cambió
      if (p.ranking !== newRanking) {
